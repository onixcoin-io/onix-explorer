...
function($scope, $rootScope, $window, $timeout, moment, getSocket, Blocks, TransactionsByDays, Constants, Status, $q, StatisticsTotalSupply, MarketsInfo) {
	...
	var socket = getSocket($scope);
		...
		self.rewardCurrency = Constants.CURRENCY.ONIX;
		self.scrollConfig = {
		...
		self.chartOptions = {
			...
			datasetOverride : [{
				...
				borderWidth: 1,
				fill: false,
				pointBorderColor: '#f4be00',
				pointBackgroundColor: '#f4be00',
				pointBorderWidth: 1,
				pointHoverBackgroundColor: '#f4be00',
				pointHoverBorderColor: '#f4be00',
